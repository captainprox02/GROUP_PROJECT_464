...
{
	partial class frm_ThemXeChoHang
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frm_ThemXeChoHang));
			...
			// txt_MaXe
			// 
			this.txt_MaXe.Location = new System.Drawing.Point(137, 37);
			...
			this.lbl_MaXe.Location = new System.Drawing.Point(40, 37);
			...
			this.lbl_MaXe.TabIndex = 21;
			this.lbl_MaXe.Text = "Mã Xe";
			// 
			// lbl_BienSo
			// 
			this.lbl_BienSo.AutoSize = true;
			this.lbl_BienSo.Location = new System.Drawing.Point(40, 78);
			...
			this.lbl_BienSo.TabIndex = 22;
			this.lbl_BienSo.Text = "Biển Số";
			// 
			// lbl_TenXe
			// 
			this.lbl_TenXe.AutoSize = true;
			this.lbl_TenXe.Location = new System.Drawing.Point(40, 115);
			...
			this.lbl_TenXe.TabIndex = 23;
			this.lbl_TenXe.Text = "Tên Xe";
			// 
			// lbl_TrongTai
			// 
			this.lbl_TrongTai.AutoSize = true;
			this.lbl_TrongTai.Location = new System.Drawing.Point(40, 150);
			...
			this.lbl_TrongTai.TabIndex = 24;
			this.lbl_TrongTai.Text = "Trọng tải";
			// 
			// lbl_NgayDangKiem
			// 
			this.lbl_NgayDangKiem.AutoSize = true;
			this.lbl_NgayDangKiem.Location = new System.Drawing.Point(40, 184);
			...
			this.lbl_NgayDangKiem.TabIndex = 25;
			this.lbl_NgayDangKiem.Text = "Ngày Đăng Kiểm";
			// 
			// lbl_TieuChuanBang
			// 
			this.lbl_TieuChuanBang.AutoSize = true;
			this.lbl_TieuChuanBang.Location = new System.Drawing.Point(40, 223);
			...
			this.lbl_TieuChuanBang.TabIndex = 26;
			this.lbl_TieuChuanBang.Text = "Tiêu Chuẩn Bằng";
			// 
			// lbl_SoTan
			// 
			this.lbl_SoTan.AutoSize = true;
			this.lbl_SoTan.Location = new System.Drawing.Point(40, 262);
			...
			this.date_NgayDangKiem.TabIndex = 28;
			// 
			// txt_BienSo
			// 
			this.txt_BienSo.Location = new System.Drawing.Point(137, 78);
			...
			this.txt_BienSo.TabIndex = 29;
			// 
			// txt_TenXe
			// 
			this.txt_TenXe.Location = new System.Drawing.Point(137, 115);
			...
			this.txt_TenXe.TabIndex = 30;
			// 
			// txt_TrongTai
			// 
			this.txt_TrongTai.Location = new System.Drawing.Point(137, 150);
			...
			this.txt_TrongTai.TabIndex = 31;
			// 
			// txt_TieuChuanBang
			// 
			this.txt_TieuChuanBang.Location = new System.Drawing.Point(137, 223);
			...
			this.txt_TieuChuanBang.TabIndex = 32;
			// 
			// txt_SoTan
			// 
			this.txt_SoTan.Location = new System.Drawing.Point(137, 262);
			...
			// btn_Them
			// 
			this.btn_Them.Location = new System.Drawing.Point(347, 312);
			...
			// btn_Thoat
			// 
			this.btn_Thoat.Location = new System.Drawing.Point(476, 312);
			...
			this.Name = "frm_ThemXeChoHang";
			this.Text = "frm_ThemXeChoHang";
